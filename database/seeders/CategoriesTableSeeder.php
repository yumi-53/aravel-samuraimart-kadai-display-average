...
class CategoriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($major_ategory_name as $major_ategory_name) {
            if ($major_ategory_name == '本') {
                foreach ($book_categories as $book_category) {
                    Category::create([
                        'name' => $book_category,
                        'description' => $book_category,
                        'major_category_name' => $major_ategory_name
                    ]);
                }
            }

            if ($major_ategory_name == 'コンピューター') {
